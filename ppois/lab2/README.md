...
TravelAgent 8 4 -> Booking, BankAccount, Salary, WorkSchedule, BookingTourFailed
Manager 6 4 -> Salary, WorkSchedule
Guide 8 5 -> City, Salary, WorkSchedule, EmployeeIsUnavailable


Accomodation 6 3 -> BankAccount, StartAndEndDateError, AccomodationNotFoundOrExpired
